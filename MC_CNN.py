...
history = model.fit(loadedImages, outputVectors, n_epoch=30,
                    validation_set = (testImages, testLabels),
                    snapshot_step=100, show_metric=True, run_id='cnnmodel_coursera')

model.save("TrainedModelCNN/CNNFIX.tfl")
